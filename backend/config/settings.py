...
SPECTACULAR_SETTINGS = {
    "TITLE": "My Driving School API",
    "DESCRIPTION": "API REST de l'intranet de gestion d'auto-ecole",
    "VERSION": "1.0.0",
...
# Initial data fixtures live in school/fixtures/ (auto-discovered by Django).
...
# Frontend base URL used to build links sent in emails (invitations, etc.)
